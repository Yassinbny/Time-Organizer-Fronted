...
const RateTask = ({ selectedEvent, setSelectedEvent }) => {
  ...
  return (
    ...
    >
      <div className="z-50">
        <h2
          className="bg-fondoPopup text-3xl pt-4 text-white rounded-t-2xl w-[70vw] md:w-[22vw]
       sm:w-[60vw] text-center sm:text-6xl"
        ...
        <form
         ...
         p-6 rounded-b-2xl shadow-lg  w-[70vw] sm:w-[60vw] md:w-[22vw] h-[70vh] text-center"
        >
          {/* <input
          type="number"
          onChange={(e) => {
        ...
        <button>enviar</button> */}
          <button
            ...
            className="bg-green-900 w-[40vw] sm:w-[10vw] h-[20vh] rounded-3xl "
          >
            1
          </button>
          <button
            ...
            className="bg-green-700 w-[40vw] sm:w-[10vw] h-[20vh] rounded-3xl "
          >
            2
          </button>
          <button
            ...
            className="bg-green-600 w-[40vw] sm:w-[10vw] h-[20vh] rounded-3xl "
          >
            3
          </button>
          <button
            ...
            className="bg-green-400 w-[40vw] sm:w-[10vw] h-[20vh] rounded-3xl "
          >
            4
          </button>
          <button
            ...
            className="bg-green-200 w-[40vw] sm:w-[10vw] h-[20vh] rounded-3xl "
          >
            5
          </button>
        </form>
