...
const SubtaskList = ({subtasks, handleDeleteSubtask, handleToggleSubtask }) => {
  ...
  return (
     ...
     <div className="flex flex-col col-span-4 items-center bg-amber-100 rounded-bl-lg p-4 md:col-span-8 w-3/5">
      ...
      <div className="pt-10 pb-6 flex flex-col items-center bg-amber-950 border-solid border-2 border-black rounded-t-3xl size-42"> 
        <h2 className="flex flex-col text-center text-3xl mx-14 font-bold text-white ">Lista</h2>
      </div>
      <div className=" items-center bg-amber-950 border-solid border-2 border-black">
      {
      ...
      <ul className=" items-center bg-amber-50 shadow-lg rounded-lg p-6 border-2 border-amber-300 min-h-[50vh] max-h-[70vh] overflow-y-auto">
